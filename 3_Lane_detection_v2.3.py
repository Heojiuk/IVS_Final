#!/usr/bin/env python3
"""
3_Lane_detection_v2.3.py  -- Perception module (marking reconstruction + no extrapolation)
...
def main():
    ...
    print("Lane detection v2.3 (Perception). Press ESC to quit.")
    ...
    print(f"  Curvature gate: |k|<={MAX_CURVATURE_1PM:.2f} 1/m (min radius {MIN_CURVE_RADIUS_M}m)")
